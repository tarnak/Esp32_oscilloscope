/*
   ...
   All-in-RAM version of Esp32_oscilloscope.ino (does not need file system and hence FTP server to make the first use esier)
...
String httpRequestHandler(String &httpRequest, httpServer::wwwSessionParameters *wsp)
{
  ...
  if (httpRequest.substring(0, 6) == "GET / " || httpRequest.substring(0, 16) == "GET /index.html " || httpRequest.substring(0, 23) == "GET /oscilloscope.html ")
  {
    ...
    return "<!DOCTYPE html>\n"
           ...
           "\n"
           "      div.d1 {position: relative; width: 100%; height: 48px}\n"
           ...
           "    <hr />\n"
           "    <div class='d1'>\n"
           "      <div class='d2'>&nbsp;Do digitalRead (GPIO)</div>\n"
           "      <div class='d3'>\n"
...
void wsRequestHandler(String &wsRequest, WebSocket *webSocket)
{
  ...
  if (wsRequest.substring(0, 21) == "GET /runOscilloscope ")
  {
    runOscilloscope(webSocket);
  } // called from oscilloscope.html
}
